  ...
  const RefreshToken = function (token) {
    fetch("https://beta.stockzoom.com/api-token-refresh/", {
      ...
      if (response.ok) {
        response.json().then(({
          token
        }) => Object(_auth_auth__WEBPACK_IMPORTED_MODULE_4__["VerifyToken"])(token));
      } else {
...
module.exports = __webpack_require__(/*! C:\Users\Darth Vader\Desktop\will_and_skill\pages\login.js */"./pages/login.js");
